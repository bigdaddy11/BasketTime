...
export function BodyMain(jsonString){
    return(
    <ScrollView contentContainerStyle={styles.body}>
        <View style={{marginBottom: 0}}>
          ...
          <View style={{marginTop: 15, flexDirection: "row", justifyContent: "space-around", borderBottomWidth: 1,
      borderBlockColor: "#3A3D40", paddingBottom: 10, marginLeft: -15}}>
